...
@click.command()
@click.option('-o', '--output-dir', default="macOS Install Data/", help="Target directory for package output.")
...
def fetchmacos(output_dir="macOS Install Data/", catalog_id="DeveloperSeed", product_id="", latest=False):
